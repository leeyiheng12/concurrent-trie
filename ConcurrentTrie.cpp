...
// The boolean is true if the word is already in the ConcurrentTrie.
std::vector<bool> ConcurrentTrie::insert(std::vector<std::string> words) {
...
std::vector<bool> ConcurrentTrie::search(std::vector<std::string> words) {
...
// Deletes a word from the ConcurrentTrie.
...
// Deletes multiple words from the ConcurrentTrie.
// Returns a vector of booleans, where each boolean corresponds to the word at the same index in the input vector.
// The boolean is true if the word was in the ConcurrentTrie and was successfully removed.
std::vector<bool> ConcurrentTrie::erase(std::vector<std::string> words) {
